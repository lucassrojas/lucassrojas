...
Me enfoco en el desarrollo de proyectos de **Análisis de Datos**, utilizando herramientas como **SQL, Excel y Power BI** para explorar datos y generar reportes útiles para la toma de decisiones.
